...
class World:
    ...
    adv_location: list[Optional[class_location.Location]]
    map: list[list[int]]
    location_data: list[Optional[class_location.Location]]
    items_data: list[Optional[class_item.Item]]
    locations: list[Optional[class_location.Location]]
    items: list[Optional[class_item.Item]]
    ...
    def __init__(self, map_data: TextIO, location_data: TextIO, items_data: TextIO) -> None:
        ...
        """
        # self.world_map = self.load_map(f)
    ...
    def first_visit_or_not(self, x: int, y: int) -> str:
        """
    ...
    def available_actions(self, player: class_player.Player) -> list[str]:
        """
    ...
    def destroy_location(self, location_name: class_location.Location) -> str:
        """
        ...
        return "Super Castle has been destroyed."
